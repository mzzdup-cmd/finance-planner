    ...
    <div>
      ...
      <div className="mx-5 mb-5 rounded-3xl bg-gradient-to-br from-success/20 to-accent/10 p-5">
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Цели на {formatMoney(totalTarget)}
        </p>
      </div>
      ...
      <div className="space-y-3 px-5">
        {active.length === 0 && completed.length === 0 ? (
          <EmptyState
            icon={Target}
            title="Нет целей"
            description="Создайте цель накопления — отпуск, подушка безопасности или крупную покупку"
        ...
        <div className="fixed inset-0 z-50 flex items-end bg-black/50 backdrop-blur-sm">
          <div className="w-full rounded-t-3xl bg-card p-6 pb-[max(2rem,env(safe-area-inset-bottom))]">
            ...
            <div className="space-y-3">
              ...
              <Input placeholder="Ежемесячно откладывать" type="number" value={monthly} onChange={(e) => setMonthly(e.target.value)} />
